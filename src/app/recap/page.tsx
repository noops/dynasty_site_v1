        ...
        <div className="space-y-10 pb-20">
            <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                <div>
                    ...
                    <p className="text-muted-foreground text-base lg:text-lg">Detailed analysis of our journey.</p>
                </div>
                ...
                {mode === "in-season" ? (
                                    ...
                                    return (
                                        <div key={i} className="glass rounded-3xl overflow-hidden border border-white/5 group hover:border-primary/20 transition-all duration-300">
                                            <div className="flex flex-col md:grid md:grid-cols-[1fr,auto,1fr] items-center p-6 lg:p-8 gap-6 lg:gap-10">
                                                {/* Team A */}
                                                <div className={cn("flex items-center gap-4 lg:gap-6 w-full md:w-auto", winner === "B" && "opacity-40")}>
                                                ...
                                                {/* Team B */}
                                                <div className={cn("flex flex-row-reverse md:flex-row items-center gap-4 lg:gap-6 text-right md:text-left w-full md:w-auto", winner === "A" && "opacity-40")}>
                                                    <div className="relative shrink-0">
                                                        <div className="w-14 h-14 lg:w-20 lg:h-20 rounded-2xl overflow-hidden border-2 border-white/10 bg-secondary/50 flex items-center justify-center">
                                                            {infoB.avatar ? (
                    ...
                    >
                        <div className="glass p-6 lg:p-10 rounded-3xl border border-white/5 lg:col-span-2 bg-gradient-to-br from-primary/5 to-transparent">
                            <h2 className="text-2xl lg:text-3xl font-outfit font-bold mb-4">2026 Offseason Preview</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
                                <div className="p-4 lg:p-6 rounded-2xl bg-white/5 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-[10px] text-muted-foreground uppercase font-bold">Rookie Draft</p>
                                        <p className="text-sm lg:text-base font-bold">May 15, 2026</p>
                                    </div>
                                </div>
                                <div className="p-4 lg:p-6 rounded-2xl bg-white/5 flex items-center gap-4">
                                    <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-xl bg-pink-500/10 flex items-center justify-center text-pink-500 shrink-0">
                                        <TrendingUp className="w-5 h-5 lg:w-6 lg:h-6" />
                                    </div>
                                    <div>
                                        <p className="text-[10px] text-muted-foreground uppercase font-bold">Trading Status</p>
                                        <p className="text-sm lg:text-base font-bold text-green-500">OPEN</p>
                                    </div>
                                </div>
                                <div className="p-4 lg:p-6 rounded-2xl bg-white/5 flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm lg:text-base font-bold font-outfit">Loading...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
